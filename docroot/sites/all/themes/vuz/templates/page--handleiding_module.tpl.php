...
<!--       <?php if (!empty($breadcrumb)): print $breadcrumb; endif;?>
    ...
    <section>
      <div class="container handleiding glossary">
...
<?php
drupal_add_js('../sites/all/themes/vuz/jsmodernizr.custom.min.js');
drupal_add_js('../sites/all/themes/vuz/js/jquery.colorbox.min.js');
drupal_add_js('../sites/all/themes/vuz/js/jquery.bxslider.min.js');
drupal_add_js('../sites/all/themes/vuz/js/glossary.js');
