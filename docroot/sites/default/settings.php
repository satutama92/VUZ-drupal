 ...
 *
 */
$drupal_hash_salt = 'rdnfagOkO_6oX0hG3tHDeh0ylkTGce0ZMAMy_Nj3Ai4';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_verzekeruzelf2016_dev_default.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_verzekeruzelf2016_dev_default.inc';
}
// </DDSETTINGS>
...
if (file_exists('/var/www/site-php')) {
  require('/var/www/site-php/verzekeruzelf2016/verzekeruzelf2016-settings.inc');
}
